...
public class NecronChestplate
    ...
    public NecronChestplate(ItemManager itemManager) {
        super(itemManager, "Necron Chestplate", ItemType.CHESTPLATE, Rarity.LEGENDARY, Material.LEATHER_CHESTPLATE);
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        gcc.setIngredient('e', new RecipeChoice.ExactChoice(itemManager.getItem(NecronFragment.class)));
        return gcc;
    }
}