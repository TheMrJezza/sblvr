...
public class NecrolordHelmet extends BaseItem {

    public NecrolordHelmet(ItemManager itemManager) {
        super(itemManager, "Necrolord Helmet", ItemType.HELMET, Rarity.LEGENDARY, Material.LEATHER_HELMET);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        recipe.setIngredient('q', new RecipeChoice.ExactChoice(itemManager.getItem(NecrolordFragment.class)));
        return recipe;
    }
}