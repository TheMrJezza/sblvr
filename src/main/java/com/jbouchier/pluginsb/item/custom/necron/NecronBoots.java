...
public class NecronBoots extends BaseItem {

    public NecronBoots(ItemManager itemManager) {
        super(itemManager, "Necron Boots", ItemType.BOOTS, Rarity.LEGENDARY, Material.LEATHER_BOOTS);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        gbc.shape("j j", "j j");
        gbc.setIngredient('j', new RecipeChoice.ExactChoice(itemManager.getItem(NecronFragment.class)));
        return gbc;
    }
}