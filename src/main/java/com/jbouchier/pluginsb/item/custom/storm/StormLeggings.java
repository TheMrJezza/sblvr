...
public class StormLeggings extends BaseItem {

    public StormLeggings(ItemManager itemManager) {
        super(itemManager, "Storm Leggings", ItemType.LEGGINGS, Rarity.LEGENDARY, Material.LEATHER_LEGGINGS);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        glc.setIngredient('g', new RecipeChoice.ExactChoice(itemManager.getItem(StormFragment.class)));
        return glc;
    }
}
