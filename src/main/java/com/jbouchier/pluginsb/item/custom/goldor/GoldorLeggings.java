...
public class GoldorLeggings extends BaseItem {

    public GoldorLeggings(ItemManager itemManager) {
        super(itemManager, "Goldor Leggings", ItemType.LEGGINGS, Rarity.LEGENDARY, Material.LEATHER_LEGGINGS);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        glc.setIngredient('g', new RecipeChoice.ExactChoice(itemManager.getItem(GoldorFragment.class)));
        return glc;
    }
}