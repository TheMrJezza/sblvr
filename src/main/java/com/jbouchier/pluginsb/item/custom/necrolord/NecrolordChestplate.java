...
public class NecrolordChestplate
        extends BaseItem {

    public NecrolordChestplate(ItemManager itemManager) {
        super(itemManager, "Necrolord Chestplate", ItemType.CHESTPLATE, Rarity.LEGENDARY, Material.LEATHER_CHESTPLATE);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        gcc.setIngredient('e', new RecipeChoice.ExactChoice(itemManager.getItem(NecrolordFragment.class)));
        return gcc;
    }
}