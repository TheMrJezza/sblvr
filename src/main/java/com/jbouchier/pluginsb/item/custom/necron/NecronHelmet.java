...
public class NecronHelmet extends BaseItem {

    public NecronHelmet(ItemManager itemManager) {
        super(itemManager, "Necron Helmet", ItemType.HELMET, Rarity.LEGENDARY, Material.LEATHER_HELMET);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        recipe.setIngredient('q', new RecipeChoice.ExactChoice(itemManager.getItem(NecronFragment.class)));
        return recipe;
    }
}