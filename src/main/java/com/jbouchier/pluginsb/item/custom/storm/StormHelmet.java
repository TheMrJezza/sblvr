...
public class StormHelmet extends BaseItem {

    public StormHelmet(ItemManager itemManager) {
        super(itemManager, "Storm Helmet", ItemType.HELMET, Rarity.LEGENDARY, Material.LEATHER_HELMET);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        recipe.setIngredient('q', new RecipeChoice.ExactChoice(itemManager.getItem(StormFragment.class)));
        return recipe;
    }
}