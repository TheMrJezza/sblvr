...
public class NecrolordLeggings extends BaseItem {

    public NecrolordLeggings(ItemManager itemManager) {
        super(itemManager, "Necrolord Leggings", ItemType.LEGGINGS, Rarity.LEGENDARY, Material.LEATHER_LEGGINGS);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        glc.setIngredient('g', new RecipeChoice.ExactChoice(itemManager.getItem(NecrolordFragment.class)));
        return glc;
    }
}
