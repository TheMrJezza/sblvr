...
public class GoldorChestplate extends BaseItem {

    public GoldorChestplate(ItemManager itemManager) {
        super(itemManager, "Goldor Chestplate", ItemType.CHESTPLATE, Rarity.LEGENDARY, Material.LEATHER_CHESTPLATE);
    }
    ...
    protected ShapedRecipe getRecipe(NamespacedKey namespace) {
        ...
        gcc.setIngredient('e', new RecipeChoice.ExactChoice(itemManager.getItem(GoldorFragment.class)));
        return gcc;
    }
}